<?php include_once "views/admin/header_admin.php" ?>
              ...
              <div class="col-md-auto mb-3 mb-md-0">
                <div class="d-flex align-items-center">
                  <img
                    ...
                    src="views\admin\assets\svg\illustrations\review-5-star.svg"
            ...
            >
              ...
              <div class="col-sm-6">
                ...
                >
                  ...
                  <!-- Select -->
                  <select
                    class="js-select2-custom js-datatable-filter custom-select-sm"
                    size="1"
                    style="opacity: 0"
                  ...
                  <th>
                    ...
                    >
                      <div class="avatar">
                        <img
                          class="avatar-img"
                          src="views\admin\assets\img\400x400\img18.jpg"
                          alt="Image Description"
                        />
                      </div>
                      <div class="ml-3">
                  ...
                  <td>
                    ...
                    >
                      <div class="avatar avatar-circle">
                        <img
                          class="avatar-img"
                          src="views\admin\assets\img\160x160\img10.jpg"
                          alt="Image Description"
                        />
                      </div>
                      <div class="ml-3">
                  ...
                  <td>
                    <div class="text-wrap" style="width: 18rem">
                      <div class="d-flex mb-2">
                        <div class="mr-1">
                          <img
                            src="views\admin\assets\svg\components\star.svg"
                            alt="Review rating"
                            width="14"
                          />
                        </div>
                  ...
                  <th>
                    ...
                    >
                      <div class="avatar">
                        <img
                          class="avatar-img"
                          src="views\admin\assets\img\400x400\img3.jpg"
                          alt="Image Description"
                        />
                      </div>
                      <div class="ml-3">
                        <span class="h5 text-hover-primary"
                          >Calvin Klein t-shirts</span
                        >
                      </div>
                    </a>
                  </th>
                  ...
                  <th>
                    ...
                    >
                      <div class="avatar">
                        <img
                          class="avatar-img"
                          src="views\admin\assets\img\400x400\img24.jpg"
                          alt="Image Description"
                        />
                      </div>
                      <div class="ml-3">
                  ...
                  <td>
                    <div class="text-wrap" style="width: 18rem">
                      <div class="d-flex mb-2">
                        ...
                        <div class="mr-1">
                          <img
                            src="views\admin\assets\svg\components\star-muted.svg"
                            alt="Review rating"
                            width="14"
                          />
                        </div>
                  ...
                  <th>
                    ...
                    >
                      <div class="avatar">
                        <img
                          class="avatar-img"
                          src="views\admin\assets\img\400x400\img19.jpg"
                          alt="Image Description"
                        />
                      </div>
                      <div class="ml-3">
                        <span class="h5 text-hover-primary"
                          >Levis women's jeans</span
                        >
                      </div>
                    </a>
                  </th>
                  ...
                  <th>
                    ...
                    >
                      <div class="avatar">
                        <img
                          class="avatar-img"
                          src="views\admin\assets\img\400x400\img11.jpg"
                          alt="Image Description"
                        />
                      </div>
                      <div class="ml-3">
                ...
                <tr>
                  ...
                  <th>
                    ...
                    >
                      <div class="avatar">
                        <img
                          class="avatar-img"
                          src="views\admin\assets\img\400x400\img7.jpg"
                          alt="Image Description"
                        />
                      </div>
                      <div class="ml-3">
                        <span class="h5 text-hover-primary"
                          >Tiro track jacket</span
                        >
                      </div>
                    </a>
                  </th>
                  ...
                  <td>
                    <div class="text-wrap" style="width: 18rem">
                      ...
                      <p>
                        Great quality, it is a loose fitting but I would
                        recommend going one size smaller as normal. I always
                        prefer bigger size so bought large for me. Love the
                        pride vibes!!!
                      </p>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <th>
                    ...
                    >
                      <div class="avatar">
                        <img
                          class="avatar-img"
                          src="views\admin\assets\img\400x400\img14.jpg"
                          alt="Image Description"
                        />
                      </div>
                      <div class="ml-3">
                  ...
                  <td>
                    <div class="text-wrap" style="width: 18rem">
                      ...
                      <p>
                        I am very pleased with my purchase. I have started to
                        have my friends become addicted to Air Jordans also.
                      </p>
                    </div>
                  </td>
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="uploadFilesModalTitle"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
