        ...
        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
          ...
          <thead class="thead-light">
            <tr>
              ...
              <th class="table-column-pl-0">Category</th>
              <th>Actions</th>
            </tr>
          </thead>
          <tbody>
                ...
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    ...
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $category['ten_loai_tour'] ?></h5>
                    </div>
                  </span>
                </td>
                <td>
                  <div class="btn-group" role="group">
                    <a class="btn btn-sm btn-outline-primary" href="?ctr=update-categories&id_loai_tour=<?= $category['id_loai_tour'] ?>">
                      <i class="tio-edit"></i> Edit
                    </a>
                  </div>
                  <div class="btn-group" role="group">
                    <a class="btn btn-sm btn-outline-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không ?')" href="?ctr=delete-categories&id_loai_tour=<?= $category['id_loai_tour'] ?>">
                      <i class="tio-delete-outlined"></i> Delete
                    </a>
                  </div>
                </td>
