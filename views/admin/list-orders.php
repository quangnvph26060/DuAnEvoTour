      ...
      <div class="row align-items-center mb-3">
        <div class="col-sm mb-2 mb-sm-0">
          <h1 class="page-header-title">
            Orders
            <span class="badge badge-soft-dark ml-2"><?= count($count_orders) ?></span>
          </h1>
        ...
        <!-- <div class="col-sm-auto">
          <a class="btn btn-primary" href="?ctr=add-category">Add category</a>
        </div> -->
      </div>
      <!-- End Row -->
        ...
        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
          ...
          <thead class="thead-light">
            <tr>
              ...
              <th class="table-column-pl-0">ID TOUR</th>
              <th class="table-column-pl-0">ID USER  (1: Khách hàng chưa có tài khoản)</th>
              <th class="table-column-pl-0">NAME TOUR</th>
              <th class="table-column-pl-0">PRICE</th>
              <th class="table-column-pl-0">IMAGES</th>
              <th class="table-column-pl-0">TOTAL MONEY</th>number of people
              <th class="table-column-pl-0">NUMBER OF PEOPLE</th>
              <th class="table-column-pl-0">USER NAME</th>
              <th class="table-column-pl-0">NUMBER PHONE</th>
              <th class="table-column-pl-0">ADDRESS</th>
              <th class="table-column-pl-0">EMAIL</th>
              <th class="table-column-pl-0">ID_BOOKING</th>
              <th class="table-column-pl-0">STATUS</th>
              <!-- <th class="table-column-pl-0">PAYMENT METHODS</th> -->
              <!-- <th class="table-column-pl-0">STATUS</th> -->
              <!-- <th class="table-column-pl-0">CODE ORDERS</th> -->
              <th>Actions</th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr>
                ...
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['id_tours'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['id_users'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['name_tour'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['price'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['img'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['tong_tien'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['soluong_nguoi'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['name'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['sdt'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['dia_chi'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['email'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['id_booking'] ?></h5>
                    </div>
                  </span>
                </td>
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <!-- <img class="avatar avatar-lg mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" /> -->
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $orders['status'] ?></h5>
                    </div>
                  </span>
                </td>
                <td>
                  <div class="btn-group" role="group">
                    <a class="btn btn-sm btn-outline-primary" href="?ctr=update-orders&id_booking=<?= $orders['id_booking_detail'] ?>">
                      <i class="tio-edit"></i> Edit
                    </a>
                  </div>
                  <div class="btn-group" role="group">
                    <a class="btn btn-sm btn-outline-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không ?')" href="?ctr=delete-orders&id_booking_detail=<?= $orders['id_booking_detail'] ?>">
                      <i class="tio-delete-outlined"></i> Delete
                    </a>
                  </div>
                </td>
