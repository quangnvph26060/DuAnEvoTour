        ...
        <table class="table table-borderless table-thead-bordered table-align-middle card-table">
          ...
          <tbody>
            <tr>
              <td>
                <a class="media align-items-center" href="project.html">
                  <img class="avatar avatar-sm mr-3" src="views\admin\assets\svg\brands\spec.svg" alt="Image Description" />
            ...
            <tr>
              <td>
                <a class="media align-items-center" href="project.html">
                  <img class="avatar avatar-sm mr-3" src="views\admin\assets\svg\brands\mailchimp.svg" alt="Image Description" />
                  <div class="media-body">
                    <span class="d-block h5 text-hover-primary mb-0">Update subscription method
                      <i class="tio-verified text-primary" data-toggle="tooltip" data-placement="top" title="Earned extra bonus"></i></span>
                  </div>
                </a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a class="media align-items-center" href="project.html">
                  <img class="avatar avatar-sm mr-3" src="views\admin\assets\svg\brands\atlassian.svg" alt="Image Description" />
                  <div class="media-body">
                    <span class="d-block h5 text-hover-primary mb-0">Develop our mobile app
                      <i class="tio-verified text-primary" data-toggle="tooltip" data-placement="top" title="Earned extra bonus"></i></span>
                  </div>
                </a>
              </td>
            ...
            <tr>
              <td>
                <a class="media align-items-center" href="project.html">
                  <img class="avatar avatar-sm mr-3" src="views\admin\assets\svg\brands\google-webdev.svg" alt="Image Description" />
                  <div class="media-body">
          ...
          <div class="card-body card-body-height">
            <ul class="list-group list-group-flush list-group-no-gutters">
              ...
              <li class="list-group-item">
                <div class="media">
                  <!-- Avatar -->
                  <img class="avatar avatar-sm avatar-circle mr-3" src="views\admin\assets\svg\brands\slack.svg" alt="Image Description" />
                  <!-- End Avatar -->
              ...
              <li class="list-group-item">
                <div class="media">
                  <!-- Avatar -->
                  <img class="avatar avatar-sm avatar-circle mr-3" src="views\admin\assets\svg\brands\bank-of-america.svg" alt="Image Description" />
                  <!-- End Avatar -->
              ...
              <li class="list-group-item">
                <div class="media">
                  <!-- Avatar -->
                  <img class="avatar avatar-sm avatar-circle mr-3" src="views\admin\assets\svg\brands\spotify.svg" alt="Image Description" />
                  <!-- End Avatar -->
              ...
              <li class="list-group-item">
                <div class="media">
                  <!-- Avatar -->
                  <img class="avatar avatar-sm avatar-circle mr-3" src="views\admin\assets\img\160x160\img9.jpg" alt="Image Description" />
                  <!-- End Avatar -->
        ...
        <div class="col-lg-4">
          ...
          <div class="card-body bg-light h-100">
            <div class="d-flex align-items-center">
              ...
              <img class="avatar avatar-xl avatar-4by3" src="views\admin\assets\svg\illustrations\review-5-star.svg" alt="Image Description" />
            </div>
          ...
          <div class="card-body card-body-height" style="height: 25rem">
            ...
            <ul class="list-comment">
              ...
              <li class="list-comment-item">
                      ...
                      <div class="col">
                        ...
                        <ul class="list-inline font-size-sm">
                          <li class="list-inline-item">
                            ...
                            <div class="d-flex">
                              <div class="mr-1">
                                <img src="views\admin\assets\svg\components\star.svg" alt="Review rating" width="12" />
                              </div>
                              <div class="mr-1">
                                <img src="views\admin\assets\svg\components\star.svg" alt="Review rating" width="12" />
                              </div>
                      ...
                      <div class="col-auto">
                        ...
                        <div class="hs-unfold">
                          ...
                          <div id="reviewMoreDropdown1" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right mt-1">
                            <a class="dropdown-item" href="#">
                              <i class="tio-flag-outlined dropdown-item-icon"></i>
                              Flag as inappropriate
                            </a>

                            <a class="dropdown-item" href="#">
                              <i class="tio-unsubscribe dropdown-item-icon"></i>
                              Flag as spam
                            </a>
                          </div>
                        </div>
                ...
                <p>
                  Another great template from Htmlstream! Refreshing and
                  Thought provoking design and it changes my view about how
                  I design the websites. Great typography, modern clean
                  white design, nice tones of the color. SVG artifacts are a
                  plus.
                </p>

                <a href="#"> <i class="tio-reply"></i> Reply </a>
              </li>
              <!-- End Review -->
              ...
              <li class="list-comment-item">
                ...
                <p>
                  Truly great. Well done. Carefully structured. Happy with
                  the template.
                </p>
                ...
                <blockquote class="blockquote mt-4">
                  ...
                  <div class="media">
                    <div class="avatar avatar-sm avatar-circle mb-2 mr-2">
                      <img class="avatar-img" src="views\admin\assets\svg\brands\htmlstream.svg" alt="Image Description" />
                    </div>
                  ...
                  Awesome! We are super glad to hear that everything is
              ...
              <li class="list-comment-item">
                ...
                <p>
                  Got a very quick response on my inquiry, very nice! Love
                  the template, beautifull components!
                </p>
                ...
                <blockquote class="blockquote mt-4">
                  ...
                  Hey Bob, thanks a lot for sharing your experience - we do
        ...
        onRegionTipShow: function(e, el, code) {
          ...
          if (marker) {
            el.html(
              ...
              '<img class="avatar avatar-xss avatar-circle mr-2" src="' +
              marker["flag"] +
              '" alt="Flag">' +
              '<span class="h5 mb-0">' +
              marker["name"] +
              ...
              '<dd class="col-sm-6 text-sm-right mb-0">' +
              marker["active"] +
              "</dd>" +
