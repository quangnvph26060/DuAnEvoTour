...
<main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
        ...
        <!-- End Page Header -->
        <form action="?ctr=edit-orders" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-8">
                    <!-- Card -->
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <!-- Body -->
                        <div class="card-body">
                            <input type="hidden" name="id_booking_detail" value="<?= $orders['id_booking_detail'] ?>">
                            <!-- Form Group -->
                            <div class="form-group" style="margin-bottom: 0;">
                                <label for="productNameLabel" class="input-label">Trạng Thái Đơn Hàng <br>
