...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    ...
    <div class="page-header">
      <div class="row align-items-center">
        <div class="col-sm mb-2 mb-sm-0">
          ...
          <h1 class="page-header-title"><?= $category['ten_loai_tour'] ?></h1>
    ...
    <!-- End Page Header -->
    <form action="?ctr=edit-categories" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-lg-8">
          <!-- Card -->
          <div class="card mb-3 mb-lg-5">
            ...
            <!-- Body -->
            <div class="card-body">
              <input type="hidden" name="id_loai_tour" value="<?= $category['id_loai_tour'] ?>">
              <!-- Form Group -->
              <div class="form-group" style="margin-bottom: 0;">
                ...
                <input type="text" class="form-control" name="ten_loai_tour" id="productNameLabel" placeholder="Nhập tên danh mục" aria-label="Shirt, t-shirts, etc." value="<?= $category['ten_loai_tour'] ?>" />
