        ...
        <div class="row align-items-center flex-grow-1">
          <div class="col-sm mb-2 mb-sm-0">
            <h4 class="card-header-title">
              Sales
              <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Net sales (gross sales minus discounts and returns) plus taxes and shipping. Includes orders from all sales channels."></i>
            </h4>
          </div>
    ...
    <div class="row">
      <div class="col-lg-4 mb-3 mb-lg-5">
        ...
        <a class="card card-hover-shadow mb-4" href="#">
          <div class="card-body">
            <div class="media align-items-center">
              <img class="avatar avatar-xl mr-4" src="views\admin\assets\svg\illustrations\create.svg" alt="Image Description" />
        ...
        <a class="card card-hover-shadow mb-4" href="#">
          <div class="card-body">
            <div class="media align-items-center">
              <img class="avatar avatar-xl mr-4" src="views\admin\assets\svg\illustrations\choice.svg" alt="Image Description" />
        ...
        <a class="card card-hover-shadow" href="#">
          <div class="card-body">
            <div class="media align-items-center">
              <img class="avatar avatar-xl mr-4" src="views\admin\assets\svg\illustrations\presenting.svg" alt="Image Description" />
                ...
                <tbody>
                  <tr>
                    <td>
                      ...
                      <a class="media align-items-center" href="./ecommerce-product-description.html">
                        <img class="avatar mr-3" src="views\admin\assets\img\400x400\img4.jpg" alt="Image Description" />
                  ...
                  <tr>
                    <td>
                      <!-- Media -->
                      <a class="media align-items-center" href="./ecommerce-product-description.html">
                        <img class="avatar mr-3" src="views\admin\assets\img\400x400\img26.jpg" alt="Image Description" />
                  ...
                  <tr>
                    <td>
                      <!-- Media -->
                      <a class="media align-items-center" href="./ecommerce-product-description.html">
                        <img class="avatar mr-3" src="views\admin\assets\img\400x400\img25.jpg" alt="Image Description" />
                  ...
                  <tr>
                    <td>
                      <!-- Media -->
                      <a class="media align-items-center" href="./ecommerce-product-description.html">
                        <img class="avatar mr-3" src="views\admin\assets\img\400x400\img6.jpg" alt="Image Description" />
                  ...
                  <tr>
                    <td>
                      <!-- Media -->
                      <a class="media align-items-center" href="./ecommerce-product-description.html">
                        <img class="avatar mr-3" src="views\admin\assets\img\400x400\img3.jpg" alt="Image Description" />
                  ...
                  <tr>
                    <td>
                      <!-- Media -->
                      <a class="media align-items-center" href="./ecommerce-product-description.html">
                        <img class="avatar mr-3" src="views\admin\assets\img\400x400\img5.jpg" alt="Image Description" />
      ...
      <div class="card-header">
        <div class="row align-items-sm-center flex-grow-1">
          <div class="col-sm mb-2 mb-sm-0">
            <h4 class="card-header-title">
              Your top countries
              <i class="tio-verified text-primary" data-toggle="tooltip" data-placement="top" title="This report is based on 100% of sessions."></i>
            </h4>
          </div>
          <div class="col-sm-auto">
            <a class="btn btn-sm btn-ghost-secondary" href="#">View all</a>
              ...
              <table class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="avatar-xss avatar-circle mr-2" src="views\admin\assets\vendor\flag-icon-css\flags\1x1\us.svg" alt="Image description" />
                        <div class="media-body">USA</div>
                      </div>
                    </td>
                    <td>10,013</td>
                    <td>$5,361</td>
                    <td>
                      <div class="d-flex align-items-center">
                        73.2%
                        <i class="tio-trending-up text-success ml-1"></i>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="avatar-xss avatar-circle mr-2" src="views\admin\assets\vendor\flag-icon-css\flags\1x1\in.svg" alt="Image description" />
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        45.8%
                        <i class="tio-trending-down text-danger ml-1"></i>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="avatar-xss avatar-circle mr-2" src="views\admin\assets\vendor\flag-icon-css\flags\1x1\ca.svg" alt="Image description" />
                  ...
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="avatar-xss avatar-circle mr-2" src="views\admin\assets\vendor\flag-icon-css\flags\1x1\de.svg" alt="Image description" />
                        <div class="media-body">Germany</div>
                      </div>
                    </td>
                    <td>4,512</td>
                    <td>$2,512</td>
                  ...
                  <tr>
                    <td>
                      <div class="media align-items-center">
                        <img class="avatar-xss avatar-circle mr-2" src="views\admin\assets\vendor\flag-icon-css\flags\1x1\gb.svg" alt="Image description" />
                        <div class="media-body">UK</div>
                      </div>
                    </td>
                    <td>3,795</td>
                    <td>$1,173</td>
          ...
          <div class="card-body">
            ...
            <div class="row align-items-sm-center mb-5">
              ...
              <div class="col-sm-auto">
                ...
                <span class="d-block">&mdash; 1,347,935 orders
                  <span class="badge badge-soft-dark badge-pill ml-1">+$97k today</span></span>
              </div>
            </div>
            <!-- End Row -->
          ...
          <div class="card-body">
            ...
            <div class="row align-items-sm-center mb-5">
              ...
              <div class="col-sm-auto">
                ...
                <span class="d-block">&mdash; 467,001 unique
                  <span class="badge badge-soft-dark badge-pill ml-1">+7k today</span></span>
              </div>
            </div>
            <!-- End Row -->
          ...
          <div class="card-body">
            ...
            <div class="row align-items-sm-center mb-5">
              ...
              <div class="col-sm-auto">
                ...
                <span class="d-block">&mdash; orders over time
                  <span class="badge badge-soft-dark badge-pill ml-1">+5k today</span></span>
              </div>
            </div>
            <!-- End Row -->
          ...
          <div class="card-body">
            ...
            <div class="row align-items-sm-center mb-5">
              ...
              <div class="col-sm-auto">
                ...
                <span class="d-block">&mdash; refunds over time
                  <span class="badge badge-soft-dark badge-pill ml-1">+21 today</span></span>
              </div>
            </div>
            <!-- End Row -->
