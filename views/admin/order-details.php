              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-no-gutter">
                  <li class="breadcrumb-item">
                    <a class="breadcrumb-link" href="ecommerce-orders.html"
                      >Orders</a
                    >
                  </li>
              ...
              <div class="mt-2">
                ...
                <div class="hs-unfold">
                  ...
                  >
                    ...
                    <a class="dropdown-item" href="#">
                      <i class="tio-visible dropdown-item-icon"></i> View order
                      status page
                    </a>
                    <a class="dropdown-item" href="#">
              ...
              <div class="card-body">
                ...
                <div class="media">
                  <div class="avatar avatar-xl mr-3">
                    <img
                      class="img-fluid"
                      src="views\admin\assets\img\400x400\img26.jpg"
                ...
                <div class="media">
                  <div class="avatar avatar-xl mr-3">
                    <img
                      class="img-fluid"
                      src="views\admin\assets\img\400x400\img22.jpg"
                      alt="Image Description"
                    />
                  </div>
                ...
                <div class="media">
                  <div class="avatar avatar-xl mr-3">
                    <img
                      class="img-fluid"
                      src="views\admin\assets\img\400x400\img15.jpg"
                      alt="Image Description"
                    />
                  </div>
              ...
              <div class="card-header">
                <h4 class="card-header-title">
                  ...
                  <span class="badge badge-soft-dark ml-1">
                    <span class="legend-indicator bg-dark"></span>Marked as
                    fulfilled
                  </span>
                </h4>
              </div>
              ...
              <div class="card-body">
                ...
                <ul class="step step-icon-xs">
                  ...
                  <li class="step-item">
                    <div class="step-content-wrapper">
                      <span
                        class="step-icon step-icon-soft-dark step-icon-pseudo"
                      ></span>
                      ...
                      <div class="step-content">
                        <h5 class="mb-1">
                          <a class="text-dark" href="#"
                            >Package arrived at the final delivery station</a
                          >
                        </h5>
              ...
              <div class="card-body">
                ...
                <span class="d-block">
                  ...
                  <img
                    ...
                    src="views\admin\assets\vendor\flag-icon-css\flags\1x1\gb.svg"
